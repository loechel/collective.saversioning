...
# Based on Example by Fabiano Weimar dos Santos https://github.com/xiru/xiru.alchemyform/blob/master/xiru/alchemyform/history_meta.py
# which based on https://bitbucket.org/sqlalchemy/sqlalchemy/src/de4eb56fb6c8/examples/versioning/history_meta.py
...
class ZopeVersionedTransactionExtension(ZopeTransactionExtension, VersionedListener):
    pass
